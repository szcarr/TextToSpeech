...
def fileContainsString(filePathAndName, stringToSearchFor):

    '''
    Like the java method contains()
    Returns true if stringToSearchFor exists in the given file
    User have to exclude linebreak
    '''
    ...
    for line in file:
        ...
        for split in splitList:
            fileOutput.append(split)

    stringExist = False
    #print(fileOutput)
    for outputString in fileOutput:
        print(outputString, stringToSearchFor)
        if stringToSearchFor in outputString:
            stringExist = True
...
#print(getPathToCurrentDir())
#var = fileContainsString(getPathToCurrentDir() + "rc.local", "IPdisplayscreen/src/startipdisplay.sh &")
#var = fileContainsString(getPathToCurrentDir() + "rc.local", "IPdisplayscreen/src/start.sh &")
#print(var)
